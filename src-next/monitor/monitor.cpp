...
// Component Monitor::RegisterComponent() {
//   return component_manager_.RegisterComponent<Component_t>();
// }

// template <typename Component_t>
// void Monitor::AttachComponent(Entity entity, Component_t component_new) {
...
// template <typename Component_t>
// void Monitor::RemoveComponent(Entity entity) {
...
// Entity Monitor::AddEntity() {
//   return entity_manager_.CreateEntity();
// }

// void Monitor::RemoveEntity(Entity entity) {
...
// template <typename Component_t>
// void Monitor::SetSystemSignature(Signature signature) {
//   system_manager_.SetSignature<Component_t>(signature);
// }

// template <typename System_t>
// System_t* Monitor::RegisterSystem(std::vector<Component> components) {
...
// template <typename System_t>
// System_t* Monitor::GetSystem() {
//   return system_manager_.GetSystem<System_t>();
// }

// template <typename Component_t>
// Component_t* Monitor::GetComponent(Entity entity) {
//   return component_manager_.GetComponent<Component_t>(entity);
// }

// bool Monitor::CheckIfEntityExists(Entity entity) {
//   return entity_manager_.CheckIfEntityExists(entity);
// }

// void Monitor::UpdateSignature(Entity entity, Signature signature) {
